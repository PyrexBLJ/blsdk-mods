...
def miniboss_shootable_objects(this_map: maps.MapData, hitloc) -> None:
    ...
    if (
        ...
        if GameState.level_offset == 2:
            bsl.ItemPools = [unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.WeaponPools.Pool_Weapons_All_05_VeryRare_Alien")]
        else:
            bsl.ItemPools = [unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Soldier.TedioreUncommon")]
