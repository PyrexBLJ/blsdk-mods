    ...
    if State.vault_symbol is not None and GameState.map_is_loaded and not GameState.current_map.custom_map_data[1]:
        ...
        if (
            ...
            if GameState.level_offset > 0:
                bsl_obj.ItemPools = [unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Assassin.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Assassin.TedioreUncommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.AmmoAndResourcePools.Pool_Eridium_Bar"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.AmmoAndResourcePools.Pool_Eridium_Bar")]
            else:
                bsl_obj.ItemPools = [unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.ArtifactPools.Pool_Artifacts_03_Rare"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.ArtifactPools.Pool_Artifacts_03_Rare"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.AmmoAndResourcePools.Pool_Eridium_Bar"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.AmmoAndResourcePools.Pool_Eridium_Bar")]
            bsl_obj.SpawnVelocityRelativeTo = 0
            bsl_obj.bTorque = False
