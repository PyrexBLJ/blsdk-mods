...
class QuestionLib:
    ...
    HARD_TRIVIA_QUESTIONS: List[list] = [
        ...
        ["Which map is Mad Mike located in?", "Eridium Blights", "Bloodshot Stronghold", "Sawtooth Cauldron", 2],
        ...
        ["What is the elemental multiplier for fire on flesh enemies in TVHM?", "1.5x", "1.75x", "2.0x", 2],
        ...
        ["How many vault symbol challenges are in Arid Nexus Badlands?", "0", "2", "3", 1],
