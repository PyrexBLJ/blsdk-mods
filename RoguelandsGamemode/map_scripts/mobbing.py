    ...
    if State.prismatic_plate is not None and not GameState.current_map.custom_map_data[0]:
        ...
        if (
            ...
            if GameState.level_offset == 2:
                bsl_obj.ItemPools = [unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Siren.MaliwanCommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_CustomItemPools_MainGame.Assassin.MaliwanCommon"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.EnemyDropPools.Pool_GunsAndGear_06_Legendary"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.AmmoAndResourcePools.Pool_Eridium_Bar"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.AmmoAndResourcePools.Pool_Eridium_Bar"), unrealsdk.FindObject("ItemPoolDefinition", "GD_Itempools.AmmoAndResourcePools.Pool_Eridium_Bar")]
            else:
