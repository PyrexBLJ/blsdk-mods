...
MAP_DATA: Dict[MapType, List[MapData]] = { 
    MapType.Mobbing:[
        ...
        MapData("Frostburn Canyon", "icecanyon_p", "GD_FastTravelStations.Zone1.IceCanyon", (14857.6181640625, 11037.859375, -784.7105102539062), (31, -101594, 0), 0, 15, 0, 0, [False, False, False], "A7 Frostburn Canyon Mobbing 1.json", False, "", False, True),
        ...
        MapData("Lynchwood", "grass_lynchwood_p", "GD_FastTravelStations.Interlude.Lynchwood", (6430.12255859375, 4772.53955078125, 817.9797973632812), (65109, 17207, 0), 0, 10, 0, 0, [False, False, False], "A33 Lynchwood Mobbing 1.json", False, "", False, True),
        ...
        MapData("Opportunity", "hyperioncity_p", "GD_FastTravelStations.Zone2.HyperionCity", (16949.87109375, 3181.3193359375, 1943.8834228515625), (65261, 24522, 0), 0, 10, 0, 0, [False, False, False], "A37 Opportunity Mobbing 2.json", False, "", False, True),
        ...
        MapData("Wurmwater", "orchid_saltflats_p", "GD_Orchid_FastTravel.SaltFlats.SaltFlats", (43722.984375, -57726.26171875, 3973.85009765625), (65532, -34763, 0), 0, 15, 0, 0, [False, False, False], "A62 Wurmwater Mobbing 4.json"),
        ...
        MapData("Ardortion Station", "sage_powerstation_p", "GD_Sage_FastTravel.PowerStation", (-23703.1593125, -12586.6748046875, 3166.949951171875), (65458, 29914, 0), 0, 10, 0, 0, [False, False, False], "A77 Ardorton Station Mobbing 1.json", False, "", False, True),
    ...
    MapType.RedBarBoss:[
        ...
        MapData("Motor Mama", "iris_hub2_p", "GD_Iris_FastTravelStations.SouthernRaceway", (-42478.54296875, 43019.8984375, -4666.150390625), (55, 61813, 0), 0, 0, 0, 1, [["AIClassDefinition GD_Iris_MotorMama.Character.CharClass_Iris_MotorMama"]], "C5 Motor Mama Boss.json"),
    ...
    MapType.MiniGame:[
        ...
        MapData("Find Buttstallion", "dam_p", "GD_FastTravelStations.Zone1.GoshDam", (-28915.439453125, 18473.8046875, 2108.46044921875), (64740, -58809, 0), 0, 99999, 0, 0, [(-28618.25390625, 19602.751953125, 2108.46044921875), False, False, False], "E4 Bloodshot Secret Rooms 1.json", False, "Find Buttstallion!", False),
